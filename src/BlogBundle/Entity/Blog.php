...
class Blog
{
	...
	public function __construct(){
		// le\ signifie que c'est la classe interne de php et pas une classe de nom
		$this->date = new \DateTime(); //définit les valeurs par défaut
		$this->auteur = " moi"; // Définit les valeurs par défaut
